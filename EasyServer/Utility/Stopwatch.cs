...
public struct Stopwatch
{
    private long _value;
        ...
        public static Stopwatch StartNew() => new(GetTimestamp());

        /// <summary>
        /// Starts a new instance with the specified duration already elapsed.
        /// </summary>
        /// <returns>A new, running stopwatch.</returns>
        public static Stopwatch StartNew(long elapsedMs) => new(GetTimestamp() - elapsedMs);

        /// <summary>
        /// Creates a new instance with the specified timestamp.
        /// </summary>
        /// <returns>A new stopwatch.</returns>
        public static Stopwatch FromTimestamp(long timestamp) => new(timestamp);
        ...
        /// <summary>
        /// Returns a new, stopped <see cref="Stopwatch"/> with the provided start and end timestamps.
        /// </summary>
        /// <param name="start">The start timestamp.</param>
        /// <param name="end">The end timestamp.</param>
        /// <returns>A new, stopped <see cref="Stopwatch"/> with the provided start and end timestamps.</returns>
        public static Stopwatch FromTimestamp(long start, long end) => new(-(end - start));
        ...
        public override readonly bool Equals(object? obj) => obj is Stopwatch stopwatch && _value == stopwatch._value;
        public readonly bool Equals(Stopwatch other) => _value == other._value;
        public override readonly int GetHashCode() => HashCode.Combine(_value);
        public static bool operator ==(Stopwatch left, Stopwatch right) => left.Equals(right);
        public static bool operator !=(Stopwatch left, Stopwatch right) => !left.Equals(right);
}