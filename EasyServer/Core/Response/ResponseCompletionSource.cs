...
internal sealed class ResponseCompletionSource : IResponseCompletionSource, IValueTaskSource<Response>, IValueTaskSource
{
...
/// <summary>
    ...
    internal sealed class ResponseCompletionSource<TResult> : IResponseCompletionSource, IValueTaskSource<TResult>, IValueTaskSource
    {
        ...
        /// </summary>
        /// <param name="value">The result value.</param>
        internal void Complete(Response<TResult> value)
        {
