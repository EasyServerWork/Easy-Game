...
/// </summary>
internal static class ResponseCompletionSourcePool
{
    internal static readonly ConcurrentObjectPool<ResponseCompletionSource, DefaultConcurrentObjectPoolPolicy<ResponseCompletionSource>> UntypedPool = 
        new(new());
